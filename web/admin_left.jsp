			...
			<div class="span2 main-menu-span">
				<div class="well nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li><a class="ajax-link" href="product_donation_list.jsp"><i class="icon-list-alt"></i><span class="hidden-tablet"> 旅游记忆信息列表</span></a></li>
						...
						<li><a class="ajax-link" href="order_list.jsp"><i class="icon-list-alt"></i><span class="hidden-tablet"> 攻略列表</span></a></li>
						<li class="nav-header hidden-tablet">公告</li>
						<li><a class="ajax-link" href="announcement.jsp"><i class="icon-edit"></i><span class="hidden-tablet"> 发布新公告</span></a></li>
						<li><a class="ajax-link" href="announcement_list.jsp"><i class="icon-cog"></i><span class="hidden-tablet"> 管理已发布公告</span></a></li>
					</ul>
				</div><!--/.well -->
			</div><!--/span-->
		</div>
